# GravityBlastr Doesn't Punch Ray

You don't have to punch Ray and Jeremy anymore to sell to them.
The sell option is now included in their store dialog choices.

## Features

- Sell option added directly to Ray's dialog
- Sell option added directly to Jeremy's dialog
- No more punching required to access the sell menu
