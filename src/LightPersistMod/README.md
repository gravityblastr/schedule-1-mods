# GravityBlastr Light Memory

Saves and restores the state of your flashlight and vehicle headlights across game loads.
If you left your headlights on when you saved, they'll be on when you load.

## Features

- Flashlight state persists across saves
- Vehicle headlight state persists across saves
- Automatic restore on game load
